...
There may be a relation between countries that are close together. But this analysis requires typing in a lot of data from the world health organization that I really don't want to do unless I have to so I'm going to wait and see what Kibria says.
